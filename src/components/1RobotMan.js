...
const Robotman = () => {
    ...
    return (
        <div className="compCntr">
            ...
            <a className="compLive" target="_blank" href="https://jkim057.github.io/RobotMan/">Live Version</a>
            <a className="compGithub" target="_blank" href="https://github.com/jkim057/RobotMan">Github</a>
